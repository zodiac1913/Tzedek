...
(function () {
  ...
  function ensurePanelStyles() {
    ...
    style.textContent = [
      ...
      "#" + PANEL_ID + " .smlc-headline{display:flex;justify-content:space-between;align-items:center;gap:0.6rem;white-space:nowrap;overflow-x:auto;}",
      "#" + PANEL_ID + " .smlc-headline-main{display:flex;align-items:center;gap:0.45rem;flex-wrap:nowrap;}",
      ...
      "#" + PANEL_ID + " .smlc-toggle-btn{background:#fff;color:#0f172a;}",
      "#" + PANEL_ID + " .smlc-refresh-btn{display:inline-flex;align-items:center;justify-content:center;min-width:31px;background:#bae6fd;color:#082f49;line-height:1;font-size:1.75rem;box-shadow:0 0.35rem 0.9rem rgba(125,211,252,0.45);}",
      ...
      "#" + PANEL_ID + " .smlc-actions{display:flex;justify-content:flex-end;gap:0.35rem;flex-wrap:nowrap;}",
      "#" + PANEL_ID + " .smlc-close-btn{border:1px solid #334155;background:#fff;border-radius:6px;padding:0.15rem 0.45rem;font-size:0.8rem;cursor:pointer;}"
    ].join("");
